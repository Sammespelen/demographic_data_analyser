...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = round((len(df.loc[
    ...
    india_people_rich = df[(df['native-country'] == 'India') & (df['salary'] == '>50K')]
    top_IN_occupation = (india_people_rich['occupation'].value_counts()).idxmax()
